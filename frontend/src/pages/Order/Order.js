...
const Order = ({ match, history }) => {
    ...
    const makePayment = async () => {
        ...
        try {
            const stripe = await loadStripe('pk_test_51O2WXALLS9FttwFMR34vSJQshxFtBi91LOtppjrkltIXa1W1OOChxioW8tzLwyIEAqrMfhZjbCc3FHimsMf69CuP006DSJnqjH');
        ...
        if (result.error) {
          ...
          } else if (result.complete === 'success') {
                            ...
                            <>
                                ...
                                {!sdkReady ? (
                                  ...
                                  order.paymentMethod === "stripe" ? (
                                        <div>
                                           <button className='btn btn-success' onClick={makePayment}>Stripe Payment</button>
                                        </div>
                                    ) : (
                                        <div>
